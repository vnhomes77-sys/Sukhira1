        ...
        <div ref={containerRef} className="relative w-full max-w-xs md:max-w-sm lg:max-w-md pointer-events-auto">
            <form onSubmit={handleSubmit} className="relative group">
                <input
                    ...
                    className="w-full bg-[#1D1D1B]/85 backdrop-blur-md border border-white/10 text-white rounded-full pl-10 pr-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#56AF31] focus:border-transparent placeholder-white/50 transition-all shadow-lg"
                />
